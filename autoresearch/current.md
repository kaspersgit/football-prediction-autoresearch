...
10. **Pinnacle-confirmation veto is now the dominant volume constraint, not league selection or overround.** On the 2026-08-22/23 production weekend, the veto (missing/non-confirming Pinnacle data → bet dropped) cut candidate E0/F1/N1 bets from 7 down to 1 — an 86% reduction that week. `max_overround` raised to 0.09 to test whether Greece's cap exclusion was the bottleneck instead; it wasn't (see `EXP-20260823-001`, reverted — G1 already clears 0.07 in 95/~500 historical bets, that weekend's 4-for-4 exclusion was a one-off odds fluctuation, not structural). The user has not yet decided whether to trade some of the veto's ROI/significance for more weekly volume (539 bets/+22.42%/t=3.42 with the veto vs. 745 bets/+15.46%/t=2.81 on the old "skip if missing" behavior, per `EXP-20260810-001`/`-004`) — surface this explicitly before any further volume-focused change.
